...
training.getDataFromfile("../dataset/preprocessed_data/toplabels_split/wiki10-top10labels_train.txt")
model = Model(maxParagraphs,paragraphLength,nlabels,vocabularySize,filterSizes,num_filters,poolLength,wordEmbeddingDimension,lrate)
