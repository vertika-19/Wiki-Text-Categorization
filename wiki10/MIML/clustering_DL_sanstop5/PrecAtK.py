...
if __name__ == '__main__':
    testfile = "minus_top5_dataset/wiki10_miml_minusTop5labels_test_dl.txt"
    modelfile = "/media/hdd2/miml/clustering_DL_sanstop5/models/" + sys.argv[8] + "/clustering_DL_" + sys.argv[7]
