...
training.getDataFromfile("../wiki10_miml_train.txt")
model = Model(maxParagraphs,paragraphLength,nlabels,vocabularySize,filterSizes,num_filters,wordEmbeddingDimension,lrate,keep_prob)
...
for e in range(epoch,epochEnd):
    ...
    if (e+1)%100 == 0:
        ...
        print ('saving model..')
        model.save("models/" + folder_name + "/model7_maxpool_wiki10_"+str(e+1))
