...
def ComputePrecisionK(modelfile,testfile):
    ...
    for i,v in enumerate(pred):
        ...
        pred1[ labelids.index( temp[0][0] ) / partition_size ] += 1
        pred3[ labelids.index( temp[0][0] ) / partition_size ] += 1
        pred5[ labelids.index( temp[0][0] ) / partition_size ] += 1
        #if 1 == 1:
...
if __name__ == '__main__':
    ...
    modelfile = "models/M7_50_10_2-3-4_16_50_100_300_0.001_2_0.5/clustering_DL_100"
